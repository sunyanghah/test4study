...
public class RedisSessionDAO extends AbstractSessionDAO {
    ...
    public RedisSessionDAO(RedisTemplate<String,Object> redisTemplate,Integer expire){
    ...
    public Collection<Session> getActiveSessions() {
        ...
        try {
            Set<String> keys = redisTemplate.keys(ShiroConfig.keyPrefix + "*");
    ...
    private String getRedisSessionKey(Serializable sessionId) {
        return ShiroConfig.keyPrefix + sessionId;
    }
    ...
    private void saveSession(Session session) throws UnknownSessionException {
        ...
        redisTemplate.opsForValue().set(getRedisSessionKey(session.getId()), session, expire, TimeUnit.HOURS);
