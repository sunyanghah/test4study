...
import test.study.shiro4.config.properties.AuthProperties;
...
public class ShiroConfig {
    ...
    public static final String keyPrefix = "shiro:token:";
    ...
    public RedisSessionDAO redisSessionDAO(RedisTemplate<String,Object> redisTemplate) {
        RedisSessionDAO redisSessionDAO = new RedisSessionDAO(redisTemplate,authProperties.getExpireHour());
    ...
    ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager,RedisTemplate<String,Object> redisTemplate) {
        ...
        whiteList.forEach(whiteUrl -> filterChainDefinitionMap.put(whiteUrl,"anon"));
