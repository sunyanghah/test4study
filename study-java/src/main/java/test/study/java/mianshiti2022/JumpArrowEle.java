...
/**
 * &lt;p&gt;JumpArrowEle complex type的 Java 类。
 *
 * &lt;p&gt;以下模式片段指定包含在此类中的预期内容。
 *
 * &lt;pre&gt;
 * &amp;lt;complexType name="JumpArrowEle"&amp;gt;
 *   &amp;lt;complexContent&amp;gt;
 ...
 *         &amp;lt;element name="jumpCrossID" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
@XmlType(name = "JumpArrowEle", propOrder = {
    "eleID",
    "operaType",
    "crossID",
    "x",
...
public class JumpArrowEle {
     ...
     *
     */
    public void setJumpCrossID(Integer value) {
        this.jumpCrossID = value;
    }
