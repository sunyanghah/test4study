...
public class XlsTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] data = getBackgroundBitmapData("F:\\watermark\\1119\\img.jpg"); //PNG must not have transparency
        ...
        // write out workbook
        workbook.write(new FileOutputStream("F:\\watermark\\1119\\xlstt.xls"));
        workbook.close();
