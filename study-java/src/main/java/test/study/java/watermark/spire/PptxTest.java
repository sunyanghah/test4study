...
public class PptxTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        presentation.loadFromFile("F:\\watermark\\spire\\pptx.pptx");

        //Set the text of watermarks
        String watermarkText = "这是pptx水印\n第二行\n第三行";
        ...
        presentation.saveToFile("F:\\watermark\\spire\\result\\pptx.pptx", FileFormat.PPTX_2013);
