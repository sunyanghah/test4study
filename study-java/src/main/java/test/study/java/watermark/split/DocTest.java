...
public class DocTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ByteArrayOutputStream outputStream = addToDoc(new FileInputStream("F:\\watermark\\split\\split\\first.doc"),
        ...
        outputStream.writeTo(new FileOutputStream("F:\\watermark\\split\\result\\first.doc"));
