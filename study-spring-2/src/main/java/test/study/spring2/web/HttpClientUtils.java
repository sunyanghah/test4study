...
public class HttpClientUtils {
    ...
    public static HttpClientResult doGet(String url, Map<String, String> headers, Map<String, String> params) {
        ...
        try {
            ...
            throw new RuntimeException("request failed, error message is " + e.getMessage(), e);
        } finally {
            // 释放资源
     ...
     * @throws Exception
     */
    public static HttpClientResult doPost(String url, Map<String, String> headers, Map<String, String> params, String paramType) throws Exception {
        // 创建httpClient对象
        CloseableHttpClient httpClient = HttpClients.createDefault();
    ...
    public static void packageParam(Map<String, String> params, HttpEntityEnclosingRequestBase httpMethod, String paramType) throws UnsupportedEncodingException {
        if (StringUtils.hasText(paramType) && "STRING".equals(paramType)) {
